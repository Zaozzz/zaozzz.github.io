...
## 个人简介
山东建筑大学 2023 级本科生（人工智能专业），现任智能 231 班心理委员、学校创业团队负责人。研究方向为自然语言处理、计算机视觉与信号处理，关注文本生成控制、目标检测与医学图像分类等问题。

已在 AAAI、ICASSP、Scientific Reports、Measurement Science and Technology、Journal of Real-Time Image Processing 等会议/期刊发表与录用论文 10 余篇。近一年参与山东省大学生创新创业训练计划项目 2 项，累计获得国家级、省部级与行业竞赛奖项 80 余项。

曾受邀参与 ICME、AVSS 等会议及 TKDE 等期刊审稿与程序工作。现为 AAAI 学生会员、CCF 学生会员、山东省人工智能学会学生会员。
